...
def recibo():
    ...
    x=0
    for bebiba in texto_bebida:
        if bebiba.get()!='0':
            texto_recibo.insert(END,f'{lista_bebidas[x]}\t\t{bebiba.get()}\t'
                                    f'$ {int(bebiba.get())*precios_bebida[x]}\n')
        x+=1
...
aplicacion.geometry('1400x768+0+0')
#Evitar maximizar
aplicacion.resizable(0,0)#O tambien False,False

#Titulo ventana
aplicacion.title("Mi Restaurante - Sistema de Facturación")
#Color fondo de la venta
...
#Panel costos
panel_costos=Frame(panel_izquierdo,bd=1,relief=SUNKEN,bg='azure4',padx=120)
...
#Lista de productos
lista_comidas=['Pollo','Carne','Salmon','Pizza','Hamburguesa','Perro caliente','Arroz chino','Arroz con pollo']
lista_bebidas=['Agua','Soda','Jugo','Alcohol','Vino','Avena','Yogurt','Limonada']
